...
import { CHAT_SUGGESTED_QUESTIONS } from '../data/chatPrompts';
...
export function SuggestedQuestions({ onQuestionClick, disabled }) {
  ...
  const questions = CHAT_SUGGESTED_QUESTIONS[languageCode] || CHAT_SUGGESTED_QUESTIONS.vi;
        ...
        {questions.map((q, idx) => (
          <button
            ...
            className={
              ...
              'transition-all duration-200 border-2 border-heritage-gold-300 dark:border-gray-600 ' +
              ...
              'disabled:hover:border-heritage-gold-300 dark:disabled:hover:border-gray-600 ' +
              'disabled:hover:bg-white dark:disabled:hover:bg-gray-700 disabled:hover:shadow-none group'
            }
          >
