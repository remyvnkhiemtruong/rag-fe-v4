      ...
      <div className="bg-gradient-to-r from-heritage-red-800 via-heritage-red-700 to-heritage-red-800 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-display font-bold">{t('admin.heritageManagement')}</h1>
              <p className="text-heritage-gold-300 dark:text-gray-400 text-sm">{t('admin.descHeritage')}</p>
            </div>
          </div>
        </div>
      </div>
